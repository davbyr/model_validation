...
def collect_result(result):
    global parii_list #file_names_ext, file_names_sta
    parii_list.append(result[0])
    print(result[0])
    #file_names_ext.append(result[1])
    #file_names_sta.append(result[2])
    return
...
class analyse_ts_monthly_en4():
    ...
    def __init__(self, dn_nemo_data, fn_nemo_domain, dn_en4, dn_out, 
                 ...
                 depth_bins = np.arange(-0.001,200,2)):
